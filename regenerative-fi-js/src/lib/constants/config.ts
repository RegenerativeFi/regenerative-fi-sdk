...
export const balancerVault = '0xeA280B39437a64473a0C77949759E6629eD1Dc73';
  ...
  [Network.CELO]: {
    ...
    addresses: {
      contracts: {
        ...
        multicall: '0xca11bde05977b3631167028862be2a173976ca11',
        poolDataQueries: '0x9a3a52f4462585c31025e2242c9b4074a9fb4a1f',
        balancerHelpers: '0xd5b6872d0a47b8f7f4bf115894bf7490f1913830',
        balancerRelayer: '0xf55a2728b374ea7249f83d005ec8c15280645b77',
        protocolFeePercentagesProvider:
          '0x4759f093b14438bfdd583717410e3ca164e81b2b',
        weightedPoolFactory: '0xdbd173227b8c07dc46eb2a38f937b690159cb40f',
        composableStablePoolFactory:
          '0x1051ec689f101d36271325347c21614edf03e102',
      },
      tokens: {
    ...
    urls: {
      subgraph:
        'https://api.studio.thegraph.com/query/92572/regenerative-pools-subgraph/version/latest', //TODO: DEV ENDPOINT change when published
      gaugesSubgraph: '',
      blockNumberSubgraph: '',
    },
    thirdParty: {
